...
- **Folder mindmap** - a markmap of the project shape, click to drill in.
...
- **AI module cards** - one natural-language summary per source file,
  generated by your choice of LLM and streamed in live as they finish.
- **Tech radar** - languages by lines of code, plus every framework, library
